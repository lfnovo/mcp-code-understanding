...
from code_understanding.config import load_config
from code_understanding.mcp.server.app import create_mcp_server
...
logger = logging.getLogger("code_understanding.mcp.simple_http")
